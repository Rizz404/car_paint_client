...
class UserCreateOrderPageOld extends StatefulWidget {
  ...
  static route({
    ...
    required List<String> carServices,
      ...
      MaterialPageRoute(
        builder: (_) => UserCreateOrderPageOld(
          workshopId: workshopId,
          carServices: carServices,
        ),
      );

  const UserCreateOrderPageOld({
    super.key,
  ...
  @override
  State<UserCreateOrderPageOld> createState() => _UserCreateOrderPageOldState();
}

class _UserCreateOrderPageOldState extends State<UserCreateOrderPageOld> {
