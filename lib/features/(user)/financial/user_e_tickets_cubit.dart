...
class UserETicketsCubit extends Cubit<BaseState> with Cancelable {
  final UserETicketsRepo userEticketsRepo;
  UserETicketsCubit({
    required this.userEticketsRepo,
  ...
  Future<void> getETicket(int page, CancelToken cancelToken,
    ...
    try {
      await handleBaseCubit<PaginatedData<ETicket>>(
        emit,
        () => userEticketsRepo.getModels(page, limit, cancelToken),
